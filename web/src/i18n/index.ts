  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        import_success: 'Imported {{fileName}}',
        import_failed: 'Import failed: {{message}}',
        clear_imported_success: 'Imported data cleared. The default file is now in use.',
        last_updated: 'Last Updated',
        file_data_range: 'File Data Range',
        data_source: 'Data Source',
        data_source_default: 'Default file {{fileName}}',
        data_source_imported: 'Local import {{fileName}}',
        ...
        model_price_settings_subtitle: 'Read model pricing from model-prices.json so token activity can resolve into cost analytics.',
        model_price_settings_eyebrow: 'Pricing',
        model_price_prompt: 'Prompt',
        model_price_completion: 'Completion',
        model_price_cache: 'Cache',
        saved_prices: 'Configured Prices',
        model_price_empty: 'No configured prices',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        import: '导入',
        import_json: '导入 JSON',
        clear_imported_data: '清除导入数据',
        export_success: '用量已导出',
        import_invalid: '导入文件无效',
        import_success: '已导入 {{fileName}}',
        import_failed: '导入失败：{{message}}',
        clear_imported_success: '已清除导入数据，当前改用默认文件。',
        last_updated: '最近更新',
        file_data_range: '文件数据范围',
        data_source: '数据来源',
        data_source_default: '默认文件 {{fileName}}',
        data_source_imported: '本地导入 {{fileName}}',
        ...
        model_price_settings_subtitle: '从 model-prices.json 读取模型价格，让 token 活动可以换算成成本分析。',
        model_price_settings_eyebrow: '定价',
        model_price_prompt: '输入',
        model_price_completion: '输出',
        model_price_cache: '缓存',
        saved_prices: '已配置价格',
        model_price_empty: '暂无配置价格',
